...
import com.example.jiangyue.androidap.xposedhook.wechat.HideModule;
import com.example.jiangyue.androidap.xposedhook.wechat.LuckyMoneyMessage;
import com.example.jiangyue.androidap.xposedhook.wechat.PreferencesUtils;
import com.example.jiangyue.androidap.xposedhook.wechat.VersionParam;
...
/**
 * Created by jiangyue on 17/4/10.
 */
public class WeChatXposedHook implements IXposedHookLoadPackage {


    private static final String RECEIVE_LUCKY_MONEY_REQUEST = VersionParam.WECHAT_PACKAGE_NAME + ".plugin.luckymoney.c.ae";
    ...
    public void handleLoadPackage(final XC_LoadPackage.LoadPackageParam lpparam) throws Throwable {
        if (lpparam.packageName.equals(VersionParam.WECHAT_PACKAGE_NAME)) {
            ...
            findAndHookMethod(VersionParam.luckyMoneyReceiveUI, lpparam.classLoader, VersionParam.receiveUIFunctionName, int.class, int.class, String.class, VersionParam.receiveUIParamName, new XC_MethodHook() {
                @Override
                protected void afterHookedMethod(MethodHookParam param) throws Throwable {
