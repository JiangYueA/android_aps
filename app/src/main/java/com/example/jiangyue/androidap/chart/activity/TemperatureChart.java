...
import com.example.jiangyue.androidap.chart.model.RangeCategorySeries;
...
public class TemperatureChart extends AbstractDemoChart {
  ...
  public Intent execute(Context context) {
    ...
    return ChartFactory.getRangeBarChartIntent(context, dataset, renderer, BarChart.Type.DEFAULT,
        "Temperature range");
  }
