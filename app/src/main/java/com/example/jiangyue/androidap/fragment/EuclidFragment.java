...
import com.example.jiangyue.androidap.adapter.ViewAnimator;
import com.example.jiangyue.androidap.adapter.simple.SwingLeftInAnimationAdapter;
import com.example.jiangyue.androidap.circualreveal.animation.SupportAnimator;
import com.example.jiangyue.androidap.circualreveal.animation.ViewAnimationUtils;
import com.example.jiangyue.androidap.following.EuclidListAdapter;
import com.example.jiangyue.androidap.following.EuclidState;
 ...
 */
public abstract class EuclidFragment extends _AbstractMainFragment {
    ...
    private void addOverlayListItem(Map<String, Object> item, View view) {
        if (mOverlayListItemView == null) {
            mOverlayListItemView = inflater.inflate(R.layout.overlay_list_item, mWrapper, false);
        } else {
        ...
        Picasso.with(context).load((Integer) item.get(EuclidListAdapter.KEY_AVATAR))
    ...
    private void createOpenProfileButtonAnimation() {
        if (mProfileButtonShowAnimation == null) {
            mProfileButtonShowAnimation = AnimationUtils.loadAnimation(context, R.anim.profile_button_scale);
