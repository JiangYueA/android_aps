 ...
 */
package com.example.jiangyue.androidap.chart.renderer;

import android.graphics.Color;
import android.graphics.Paint.Align;

import com.example.jiangyue.androidap.chart.util.MathHelper;
...
public class XYMultipleSeriesRenderer extends DefaultRenderer {
     ...
     * The zoom in limit permitted in the axis X
     */
    private double mZoomInMaxX = 0;
    /**
     * The zoom in limit permitted in the axis Y
     */
    private double mZoomInMaxY = 0;
    /**
     * The zoom start pos x
     */
    private double mZoomStartPosX = 0;
    private double mZoomEndPosX = 0;

    public double getmZoomStartPosX() {
        return mZoomStartPosX;
    }

    public void setmZoomStartPosX(double mZoomStartPosX) {
        this.mZoomStartPosX = mZoomStartPosX;
    }

    public double getmZoomEndPosX() {
        return mZoomEndPosX;
    }

    public void setmZoomEndPosX(double mZoomEndPosX) {
        this.mZoomEndPosX = mZoomEndPosX;
    }
    ...
    public double getmZoomInMaxX() {
        return mZoomInMaxX;
    }

    public void setmZoomInMaxX(double mZoomInMaxX) {
        this.mZoomInMaxX = mZoomInMaxX;
    }

    public double getmZoomInMaxY() {
        return mZoomInMaxY;
    }

    public void setmZoomInMaxY(double mZoomInMaxY) {
        this.mZoomInMaxY = mZoomInMaxY;
    }
