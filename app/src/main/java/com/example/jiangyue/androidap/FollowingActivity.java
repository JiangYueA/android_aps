...
import com.example.jiangyue.androidap.following.EuclidActivity;
...
public class FollowingActivity extends EuclidActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButtonProfile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(FollowingActivity.this, "Oh hi!", Toast.LENGTH_SHORT).show();
            }
        });
    }
