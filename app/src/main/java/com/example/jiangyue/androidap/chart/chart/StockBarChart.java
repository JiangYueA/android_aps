 ...
 */
public class StockBarChart extends XYChart {
    /**
     ...
     */
    public StockBarChart(XYMultipleSeriesDataset dataset, XYMultipleSeriesRenderer renderer, Type type) {
    ...
    public void drawSeries(Canvas canvas, Paint paint, List<Float> points,
        ...
        for (int i = 0; i < length; i += 2) {
            ...
            if (index % 2 == 1) {
                paint.setColor(Color.parseColor("#e4300c"));
            } else {
                paint.setColor(Color.parseColor("#19ab09"));
            }
